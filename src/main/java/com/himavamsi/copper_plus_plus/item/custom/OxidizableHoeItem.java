...
public class OxidizableHoeItem extends HoeItem implements OxidizableItem, FabricItem {
    private final Item nextStage;

    public OxidizableHoeItem(ToolMaterial material, int attackDamage, float attackSpeed,
