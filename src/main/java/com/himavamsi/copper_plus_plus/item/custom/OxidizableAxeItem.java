...
public class OxidizableAxeItem extends AxeItem implements OxidizableItem, FabricItem {
    private final Item nextStage;

    public OxidizableAxeItem(ToolMaterial material, float attackDamage, float attackSpeed,
