...
public class OxidizablePickaxeItem extends PickaxeItem implements OxidizableItem, FabricItem {
    private final Item nextStage;

    public OxidizablePickaxeItem(ToolMaterial material, int attackDamage, float attackSpeed,
