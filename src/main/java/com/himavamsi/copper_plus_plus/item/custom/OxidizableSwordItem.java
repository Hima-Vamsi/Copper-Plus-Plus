...
public class OxidizableSwordItem extends SwordItem implements OxidizableItem, FabricItem {
    private final Item nextStage;

    public OxidizableSwordItem(ToolMaterial material, int attackDamage, float attackSpeed,
